...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing-name").typed({
            strings: ["William,"],    /* You can change the home section typing text from
	                                                                                            here and do not use "&" use "and" */
            typeSpeed: 50,
            showCursor: false,
          });
        $(".typing-description").typed({
            strings: ["^1000 Shower Singer", "^500 Software Engineer."],    /* You can change the home section typing text from
                                                                                              here and do not use "&" use "and" */
            typeSpeed: 50,
